...
export default function Hero() {
    ...
    return (
        <section className="m-20 flex flex-col items-center justify-center">
            <h1 className="text-4xl font-bold text-white">MacBook Pro</h1>
            <img className="w-1/2" src="/title.png" alt="title" />
            ...
            ">Buy</button>
            <br />
            <p className="text-xl">From $1599 ot $$133/mo for the first 12 months</p>
        </section>
    );
}